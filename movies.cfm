...
<cfif structKeyExists(URL,'search_term')>
    <cfif URL.search_term NEQ "">        
        <cfinvoke component="#MovieList#" method="getSearchMovies" returnvariable="Movies">
            <cfinvokeargument  name="search_term" value="#URL.search_term#" />
        </cfinvoke>
    </cfif>
<cfelse>    
